        ...
        <div class="row">
            <div class="col-12 col-lg-8 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        <h5 class="card-title mb-4">Edit Service Information</h5>
                            ...
                            <div class="row g-4">
                                    ...
                                    <select name="motor_id" class="form-select @error('motor_id') is-invalid @enderror"
                                        ...
                                        @foreach ($motor as $bike)
                                            <option value="{{ $bike->id }}"
                                                {{ old('motor_id', $service->motor_id) == $bike->id ? 'selected' : '' }}>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="datetime-local" name="service_date"
                                        ...
                                        value="{{ old('service_date', $service->service_date ? \Carbon\Carbon::parse($service->service_date)->format('Y-m-d\TH:i') : '') }}"
                                        required>
                                    @error('service_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="3"
                                        placeholder="Describe the service details, issues found, or repairs needed...">{{ old('description', $service->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 mt-4">
                                    <div class="d-flex gap-2">
                                        <button type="submit" class="btn btn-primary">
                                            <i class='bx bxs-save'></i> Update Service Record
                                        </button>
            ...
            <!-- Service Types Information Card (Same as create view) -->
